...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Harvest.crop'
        db.add_column(u'harvestcount_harvest', 'crop',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crops.Crop'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Harvest.crop_variety'
        db.add_column(u'harvestcount_harvest', 'crop_variety',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crops.Variety'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Harvest.crop'
        db.delete_column(u'harvestcount_harvest', 'crop_id')

        # Deleting field 'Harvest.crop_variety'
        db.delete_column(u'harvestcount_harvest', 'crop_variety_id')
