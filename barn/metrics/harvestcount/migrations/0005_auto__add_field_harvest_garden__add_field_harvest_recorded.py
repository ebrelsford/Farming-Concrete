...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Harvest.garden'
        db.add_column(u'harvestcount_harvest', 'garden',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farmingconcrete.Garden'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Harvest.recorded'
        db.add_column(u'harvestcount_harvest', 'recorded',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Harvest.garden'
        db.delete_column(u'harvestcount_harvest', 'garden_id')

        # Deleting field 'Harvest.recorded'
        db.delete_column(u'harvestcount_harvest', 'recorded')
    ...
    models = {
        ...
        u'harvestcount.harvest': {
            ...
            'harvested': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
