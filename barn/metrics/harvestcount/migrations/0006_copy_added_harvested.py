...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Copy harvested field to recorded field"""
        for harvest in orm.Harvest.objects.all():
            harvest.recorded = harvest.harvested
            harvest.save()

    def backwards(self, orm):
        """Clear recorded field"""
        orm.Harvest.objects.update(recorded=None)
