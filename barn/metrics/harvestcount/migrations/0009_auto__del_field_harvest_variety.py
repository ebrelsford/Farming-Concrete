...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Harvest.variety'
        db.delete_column(u'harvestcount_harvest', 'variety_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Harvest.variety'
        raise RuntimeError("Cannot reverse this migration. 'Harvest.variety' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Harvest.variety'
        db.add_column(u'harvestcount_harvest', 'variety',
