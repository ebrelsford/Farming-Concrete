...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LookingGoodTag.comment'
        db.add_column(u'lookinggood_lookinggoodtag', 'comment',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LookingGoodTag.comment'
        db.delete_column(u'lookinggood_lookinggoodtag', 'comment')
