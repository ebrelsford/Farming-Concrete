...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'YumYuck'
        db.create_table(u'yumyuck_yumyuck', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('added_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'yumyuck_yumyuck_added', null=True, to=orm['auth.User'])),
            ...
            ('yuck_after', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'yumyuck', ['YumYuck'])


    def backwards(self, orm):
        # Deleting model 'YumYuck'
        db.delete_table(u'yumyuck_yumyuck')
