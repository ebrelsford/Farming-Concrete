...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'YumYuck.vegetable'
        db.delete_column(u'yumyuck_yumyuck', 'vegetable_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'YumYuck.vegetable'
        raise RuntimeError("Cannot reverse this migration. 'YumYuck.vegetable' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'YumYuck.vegetable'
        db.add_column(u'yumyuck_yumyuck', 'vegetable',
