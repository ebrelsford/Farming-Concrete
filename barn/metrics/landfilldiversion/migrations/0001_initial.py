...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LandfillDiversionWeight'
        db.create_table(u'landfilldiversion_landfilldiversionweight', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('added_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'landfilldiversion_landfilldiversionweight_added', null=True, to=orm['auth.User'])),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'landfilldiversion_landfilldiversionweight_updated', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal(u'landfilldiversion', ['LandfillDiversionWeight'])


    def backwards(self, orm):
        # Deleting model 'LandfillDiversionWeight'
        db.delete_table(u'landfilldiversion_landfilldiversionweight')
