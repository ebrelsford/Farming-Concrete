...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'HoursByTask.task'
        db.delete_column(u'participation_hoursbytask', 'task_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'HoursByTask.task'
        raise RuntimeError("Cannot reverse this migration. 'HoursByTask.task' and its values cannot be restored.")
