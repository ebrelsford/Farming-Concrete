...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HoursByGeography.in_half'
        db.add_column(u'participation_hoursbygeography', 'in_half',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'HoursByGeography.in_whole'
        db.add_column(u'participation_hoursbygeography', 'in_whole',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'HoursByGeography.out_half'
        db.add_column(u'participation_hoursbygeography', 'out_half',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'HoursByGeography.out_whole'
        db.add_column(u'participation_hoursbygeography', 'out_whole',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HoursByGeography.in_half'
        db.delete_column(u'participation_hoursbygeography', 'in_half')

        # Deleting field 'HoursByGeography.in_whole'
        db.delete_column(u'participation_hoursbygeography', 'in_whole')

        # Deleting field 'HoursByGeography.out_half'
        db.delete_column(u'participation_hoursbygeography', 'out_half')

        # Deleting field 'HoursByGeography.out_whole'
        db.delete_column(u'participation_hoursbygeography', 'out_whole')
    ...
    models = {
        ...
        u'participation.hoursbygeography': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_half': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'in_whole': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'neighborhood_definition': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'out_half': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'out_whole': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
