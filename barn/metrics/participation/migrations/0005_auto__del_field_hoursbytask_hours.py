...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HoursByTask.hours'
        db.delete_column(u'participation_hoursbytask', 'hours')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'HoursByTask.hours'
        raise RuntimeError("Cannot reverse this migration. 'HoursByTask.hours' and its values cannot be restored.")
