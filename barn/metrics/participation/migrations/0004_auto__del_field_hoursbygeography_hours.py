...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HoursByGeography.hours'
        db.delete_column(u'participation_hoursbygeography', 'hours')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'HoursByGeography.hours'
        raise RuntimeError("Cannot reverse this migration. 'HoursByGeography.hours' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'HoursByGeography.hours'
        db.add_column(u'participation_hoursbygeography', 'hours',
                      self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2),
                      keep_default=False)
