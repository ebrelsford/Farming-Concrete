...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HoursByGeography.neighborhood_definition'
        db.add_column(u'participation_hoursbygeography', 'neighborhood_definition',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HoursByGeography.neighborhood_definition'
        db.delete_column(u'participation_hoursbygeography', 'neighborhood_definition')
    ...
    models = {
        ...
        u'participation.hoursbygeography': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'neighborhood_definition': ('django.db.models.fields.TextField', [], {'null': 'True'}),
