...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'donations_donation', (
            ...
            ('added_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'donations_donation_added', null=True, to=orm['auth.User'])),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'donations_donation_updated', null=True, to=orm['auth.User'])),
            ...
            ('produce_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('pounds', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
        ))
    ...
    models = {
        ...
        u'donations.donation': {
            ...
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'donations_donation_added'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'garden': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['farmingconcrete.Garden']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pounds': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'produce_name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'recorded': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'donations_donation_updated'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
