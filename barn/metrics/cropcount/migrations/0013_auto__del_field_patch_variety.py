...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Patch.variety'
        db.delete_column(u'cropcount_patch', 'variety_id')


    def backwards(self, orm):
        # Adding field 'Patch.variety'
        db.add_column(u'cropcount_patch', 'variety',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farmingconcrete.Variety'], null=True, blank=True),
                      keep_default=False)
