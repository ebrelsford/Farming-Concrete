...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patch.crop'
        db.add_column(u'cropcount_patch', 'crop',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crops.Crop'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Patch.crop_variety'
        db.add_column(u'cropcount_patch', 'crop_variety',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crops.Variety'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patch.crop'
        db.delete_column(u'cropcount_patch', 'crop_id')

        # Deleting field 'Patch.crop_variety'
        db.delete_column(u'cropcount_patch', 'crop_variety_id')
