...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Copy garden from Boxes to Patches"""
        for patch in orm.Patch.objects.all():
            patch.garden = patch.box.garden
            patch.save()

    def backwards(self, orm):
        """Clear Patches' garden fields"""
        orm.Patch.objects.update(garden=None)
