...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patch.garden'
        db.add_column(u'cropcount_patch', 'garden',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farmingconcrete.Garden'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Patch.recorded'
        db.add_column(u'cropcount_patch', 'recorded',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patch.garden'
        db.delete_column(u'cropcount_patch', 'garden_id')

        # Deleting field 'Patch.recorded'
        db.delete_column(u'cropcount_patch', 'recorded')
