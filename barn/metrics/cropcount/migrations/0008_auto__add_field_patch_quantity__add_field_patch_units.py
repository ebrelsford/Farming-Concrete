...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patch.quantity'
        db.add_column(u'cropcount_patch', 'quantity',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Patch.units'
        db.add_column(u'cropcount_patch', 'units',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patch.quantity'
        db.delete_column(u'cropcount_patch', 'quantity')

        # Deleting field 'Patch.units'
        db.delete_column(u'cropcount_patch', 'units')
