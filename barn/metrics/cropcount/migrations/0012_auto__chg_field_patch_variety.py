...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patch.variety'
        db.alter_column(u'cropcount_patch', 'variety_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farmingconcrete.Variety'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Patch.variety'
        raise RuntimeError("Cannot reverse this migration. 'Patch.variety' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Patch.variety'
        db.alter_column(u'cropcount_patch', 'variety_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farmingconcrete.Variety']))
