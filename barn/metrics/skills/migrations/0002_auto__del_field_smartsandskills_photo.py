...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SmartsAndSkills.photo'
        db.delete_column(u'skills_smartsandskills', 'photo')


    def backwards(self, orm):
        # Adding field 'SmartsAndSkills.photo'
        db.add_column(u'skills_smartsandskills', 'photo',
