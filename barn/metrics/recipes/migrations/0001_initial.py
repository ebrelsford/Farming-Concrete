...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RecipeTally'
        db.create_table(u'recipes_recipetally', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('added_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'recipes_recipetally_added', null=True, to=orm['auth.User'])),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'recipes_recipetally_updated', null=True, to=orm['auth.User'])),
            ...
            ('recipes_count', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'recipes', ['RecipeTally'])


    def backwards(self, orm):
        # Deleting model 'RecipeTally'
        db.delete_table(u'recipes_recipetally')
    ...
    models = {
        ...
        u'recipes.recipetally': {
            'Meta': {'object_name': 'RecipeTally'},
            'added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'recipes_recipetally_added'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'garden': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['farmingconcrete.Garden']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipes_count': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'recorded': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'recorded_start': ('django.db.models.fields.DateField', [], {}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'recipes_recipetally_updated'", 'null': 'True', 'to': u"orm['auth.User']"})
        }
    }
