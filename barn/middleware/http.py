...
"""
Middleware to allow the display of a 403.html template when a 403 error is raised.

Heavily borrowed from http://mitchfournier.com/2010/07/12/show-a-custom-403-forbidden-error-page-in-django/
"""
