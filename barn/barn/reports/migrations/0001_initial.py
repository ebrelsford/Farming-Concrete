...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SharedReport'
        db.create_table('reports_sharedreport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('garden', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farmingconcrete.Garden'])),
            ('access_key', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('reports', ['SharedReport'])


    def backwards(self, orm):
        
        # Deleting model 'SharedReport'
        db.delete_table('reports_sharedreport')
