...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('harvestcount_harvest', 'harvested', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):
        
        # Changing field 'Harvest.harvested'
        db.alter_column('harvestcount_harvest', 'harvested', self.gf('django.db.models.fields.DateTimeField')())
