...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EstimatedYield.weight_per_plant'
        db.delete_column('estimates_estimatedyield', 'weight_per_plant')

        # Adding field 'EstimatedYield.pounds_per_plant'
        db.add_column('estimates_estimatedyield', 'pounds_per_plant', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'EstimatedYield.weight_per_plant'
        db.add_column('estimates_estimatedyield', 'weight_per_plant', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2), keep_default=False)

        # Deleting field 'EstimatedYield.pounds_per_plant'
        db.delete_column('estimates_estimatedyield', 'pounds_per_plant')
