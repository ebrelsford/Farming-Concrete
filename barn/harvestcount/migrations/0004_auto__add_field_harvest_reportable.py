...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Harvest.reportable'
        db.add_column('harvestcount_harvest', 'reportable', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Harvest.reportable'
        db.delete_column('harvestcount_harvest', 'reportable')
