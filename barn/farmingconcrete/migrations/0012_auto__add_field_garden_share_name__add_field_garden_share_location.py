...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Garden.share_name'
        db.add_column(u'farmingconcrete_garden', 'share_name',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Garden.share_location'
        db.add_column(u'farmingconcrete_garden', 'share_location',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Garden.share_name'
        db.delete_column(u'farmingconcrete_garden', 'share_name')

        # Deleting field 'Garden.share_location'
        db.delete_column(u'farmingconcrete_garden', 'share_location')
    ...
    models = {
        ...
        u'farmingconcrete.garden': {
            ...
            'has_metric_records': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'share_location': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'share_name': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
