...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Variety.needs_moderation'
        db.add_column('farmingconcrete_variety', 'needs_moderation', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Variety.needs_moderation'
        db.delete_column('farmingconcrete_variety', 'needs_moderation')
