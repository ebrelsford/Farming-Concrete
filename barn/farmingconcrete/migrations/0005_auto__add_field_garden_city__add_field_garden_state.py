...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Garden.city'
        db.add_column(u'farmingconcrete_garden', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Garden.state'
        db.add_column(u'farmingconcrete_garden', 'state',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Garden.city'
        db.delete_column(u'farmingconcrete_garden', 'city')

        # Deleting field 'Garden.state'
        db.delete_column(u'farmingconcrete_garden', 'state')
