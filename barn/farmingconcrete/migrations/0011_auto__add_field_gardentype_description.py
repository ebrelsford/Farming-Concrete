...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GardenType.description'
        db.add_column(u'farmingconcrete_gardentype', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GardenType.description'
        db.delete_column(u'farmingconcrete_gardentype', 'description')
