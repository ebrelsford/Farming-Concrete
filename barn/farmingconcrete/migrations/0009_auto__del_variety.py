...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'farmingconcrete_variety')


    def backwards(self, orm):
        # Adding model 'Variety'
        db.create_table(u'farmingconcrete_variety', (
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('added_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'farmingconcrete_variety_added', null=True, to=orm['auth.User'], blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'farmingconcrete_variety_updated', null=True, to=orm['auth.User'], blank=True)),
            ('needs_moderation', self.gf('django.db.models.fields.BooleanField')(default=False)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'farmingconcrete', ['Variety'])
