...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GardenGroup'
        db.create_table(u'farmingconcrete_gardengroup', (
        ...
        db.send_create_signal(u'farmingconcrete', ['GardenGroup'])

        # Adding model 'GardenGroupMembership'
        db.create_table(u'farmingconcrete_gardengroupmembership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('garden', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farmingconcrete.Garden'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farmingconcrete.GardenGroup'])),
            ('added_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'farmingconcrete', ['GardenGroupMembership'])


    def backwards(self, orm):
        # Deleting model 'GardenGroup'
        db.delete_table(u'farmingconcrete_gardengroup')

        # Deleting model 'GardenGroupMembership'
        db.delete_table(u'farmingconcrete_gardengroupmembership')
