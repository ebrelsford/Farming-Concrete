...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Garden.has_metric_records'
        db.add_column(u'farmingconcrete_garden', 'has_metric_records',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Garden.has_metric_records'
        db.delete_column(u'farmingconcrete_garden', 'has_metric_records')
