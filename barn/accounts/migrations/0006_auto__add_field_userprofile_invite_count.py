...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.invite_count'
        db.add_column(u'accounts_userprofile', 'invite_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.invite_count'
        db.delete_column(u'accounts_userprofile', 'invite_count')
    ...
    models = {
        ...
        u'accounts.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
