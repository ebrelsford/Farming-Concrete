...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Move gardens to GardenMembership"""
        for user_profile in orm.UserProfile.objects.all():
            for garden in user_profile.gardens.all():
                membership = orm.GardenMembership(
                    garden=garden,
    ...
    def backwards(self, orm):
        """Delete all GardenMembership objects"""
        orm.GardenMembership.objects.all().delete()
