...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'accounts_userprofile_gardens'))


    def backwards(self, orm):
        # Adding M2M table for field gardens on 'UserProfile'
        m2m_table_name = db.shorten_name(u'accounts_userprofile_gardens')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'accounts.userprofile'], null=False)),
            ('garden', models.ForeignKey(orm[u'farmingconcrete.garden'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'garden_id'])
