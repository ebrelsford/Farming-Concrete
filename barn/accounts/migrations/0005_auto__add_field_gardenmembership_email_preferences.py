...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GardenMembership.email_preferences'
        db.add_column(u'accounts_gardenmembership', 'email_preferences',
                      self.gf('django.db.models.fields.CharField')(default='all', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GardenMembership.email_preferences'
        db.delete_column(u'accounts_gardenmembership', 'email_preferences')
    ...
    models = {
        u'accounts.gardenmembership': {
            ...
            'email_preferences': ('django.db.models.fields.CharField', [], {'default': "'all'", 'max_length': '50'}),
        ...
        u'accounts.userprofile': {
            ...
            'gardens': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['farmingconcrete.Garden']", 'null': 'True', 'through': u"orm['accounts.GardenMembership']", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
