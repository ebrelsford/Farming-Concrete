...
define(
    [
        ...
        function addModal() {
            ...
            $('body').append(
                $('<div></div>')
                    .attr('id', 'new-gardener-modal')
                    .attr('class', 'modal')
            );
            return $('#new-gardener-modal');
        }
        ...
        function submitForm($modal, e) {
            ...
            if ($nameInput.val() !== '') {
                // If we have a name for the gardener, attempt to submit
                $form.ajaxSubmit({
                    error: function () {
                        addError($nameInput, 'There was an error while adding your gardener. Please try again.');
                    },
                    success: function (data) {
                        var $select = $('select[name=gardener]'),
                ...
                // Let the user know that we need a gardener name to submit
