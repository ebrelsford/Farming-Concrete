...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EstimatedYield.garden_type'
        db.add_column('estimates_estimatedyield', 'garden_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farmingconcrete.GardenType'], null=True, blank=True), keep_default=False)

        # Adding field 'EstimatedCost.garden_type'
        db.add_column('estimates_estimatedcost', 'garden_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farmingconcrete.GardenType'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EstimatedYield.garden_type'
        db.delete_column('estimates_estimatedyield', 'garden_type_id')

        # Deleting field 'EstimatedCost.garden_type'
        db.delete_column('estimates_estimatedcost', 'garden_type_id')
