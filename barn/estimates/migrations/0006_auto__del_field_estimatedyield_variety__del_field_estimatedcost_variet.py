...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EstimatedYield.variety'
        db.delete_column(u'estimates_estimatedyield', 'variety_id')

        # Deleting field 'EstimatedCost.variety'
        db.delete_column(u'estimates_estimatedcost', 'variety_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'EstimatedYield.variety'
        raise RuntimeError("Cannot reverse this migration. 'EstimatedYield.variety' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'EstimatedYield.variety'
        db.add_column(u'estimates_estimatedyield', 'variety',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farmingconcrete.Variety']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'EstimatedCost.variety'
        raise RuntimeError("Cannot reverse this migration. 'EstimatedCost.variety' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'EstimatedCost.variety'
        db.add_column(u'estimates_estimatedcost', 'variety',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farmingconcrete.Variety']),
                      keep_default=False)
    ...
    models = {
        ...
        u'estimates.estimatedcost': {
            ...
            'crop': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crops.Crop']", 'null': 'True'}),
